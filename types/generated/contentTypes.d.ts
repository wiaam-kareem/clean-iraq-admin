...
export interface ApiBlogBlog extends Schema.CollectionType {
  ...
  attributes: {
    titleAr: Attribute.String & Attribute.Required;
    ...
    type: Attribute.Enumeration<['educational', 'story']>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiStatisticStatistic extends Schema.CollectionType {
  ...
  attributes: {
    ...
    metric: Attribute.Integer & Attribute.Required;
...
export interface ApiUpcommingUpcomming extends Schema.SingleType {
  collectionName: 'upcommings';
  info: {
    singularName: 'upcomming';
    pluralName: 'upcommings';
  ...
  attributes: {
    title_ar: Attribute.String & Attribute.Required;
    describtion_ar: Attribute.String & Attribute.Required;
    image: Attribute.Media;
    date: Attribute.Date & Attribute.Required;
    time: Attribute.Time;
    insta_url: Attribute.String;
    facebook_url: Attribute.String;
    title_en: Attribute.String & Attribute.Required;
    describtion_en: Attribute.String & Attribute.Required;
    city: Attribute.Relation<
      'api::upcomming.upcomming',
      'oneToOne',
      'api::city.city'
    >;
    createdAt: Attribute.DateTime;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::upcomming.upcomming': ApiUpcommingUpcomming;
    }
  }
}
